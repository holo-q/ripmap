...
Monorepo fix: Flatter depth penalties require tighter focus, but thresholding is a cliff. If NDCG hits 0.0, the graph is disconnected—loosen focus constraints immediately.

Signal Hierarchy: Structural signals are high-precision but sparse. Always maintain a 'baseline' signal (Text/PageRank) to prevent zero-recall scenarios.
